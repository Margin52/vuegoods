...
var isHLJ = find('mobileflagship')
var isCMCC = find('leadeon')

if (isHLJ) {
  window.webtrendsAsyncInit = function () {
    var dcs = new Webtrends.dcs().init({
      dcsid: 'dcsw84fz1ejgi9wc8k6vl9e1r_9o9h',

      // 测试环境：qjdtest.hl139.net:9007
      // 正式环境：218.203.12.21:80
      // 正式环境：wtrace.hl139.net
      domain: 'wtrace.hl139.net',
  ...
  window.webtrendsAsyncInit = function () {
    var dcs = new Webtrends.dcs().init({
      domain: "sdc.10086.cn",
      dcsid: "dcs008vkfejgi9che86y92n3e_7t9g",
      timezone: 8,
      i18n: true,
      dcsdelay: 500,
      plugins: {}
